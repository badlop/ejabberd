...
presence_broadcast(Config) ->
    ...
    ct:pal("RRECV MESSAGE 1:~n~s~n~s", [recv_message(Config)]),
    ct:pal("RRECV MESSAGE 2:~n~s~n~s", [recv_message(Config)]),
    ct:pal("RRECV MESSAGE 3:~n~s~n~s", [recv_message(Config)]),
